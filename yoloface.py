...
# import pandas RTLD_GLOBAL
# import numpy RTLD_GLOBAL


# yolo_tiny_face.cfg
# yolov2-tiny-face.weights
# './cfg/yolov3-face.cfg'
# './model-weights/yolov3-wider_16000.weights'
model = './model-weights/yolov2-tiny-face.weights'
cfg = './cfg/yolo_tiny_face.cfg'

#####################################################################
parser = argparse.ArgumentParser()
parser.add_argument('--model-cfg', type=str, default=cfg,
...
def _main():
    ...
    while True:
        ...
        faces = post_process(frame, outs, CONF_THRESHOLD, NMS_THRESHOLD, "abc")
